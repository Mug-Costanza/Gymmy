"""
Django settings for gymmy project.
...
SECRET_KEY = 'django-insecure-9$+((3n9nvmd6^r+09h#4n%avq5z51&kz51fd5xjbz*&tc1v*0'
...
ACCOUNT_FORMS = {
    'signup': 'gym.forms.CustomSignupForm',
}

ROOT_URLCONF = 'gymmy.urls'
...
WSGI_APPLICATION = 'gymmy.wsgi.application'
